...
public interface GardenInterface {
    ...
    /*format for garden string
        #species:tomato:sunValue:pruneValue:waterValue:fertilizeValue:sunflower:sunValue:pruneValue:waterValue:fertilizeValue:#plants:x:y:tomato:sunValue:pruneValue:waterValue:fertilizeValue:x:y:sunflower:sunValue:pruneValue:waterValue:fertilizeValue
